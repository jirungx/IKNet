...
from modules.model import IKGNet
...
def load_data(price_path="dataset/snp500_dataset.csv", token_path="tokens/snp_topk25_tokens.csv"):
...
if __name__ == "__main__":
    ...
    for horizon in horizons:
        for test_year in range(2018, 2025):
            ...
            model_path = f"IKGNet_models/IKGNet_{train_start}_{test_year}_k{num_keywords}.pt"
            ...
            os.makedirs("shap_results_csv", exist_ok=True)
            ...
            daily_df.to_csv(f"shap_results_csv/keyword_shap_table_{test_year}_k{num_keywords}.csv", index=False)
            print(f"Saved daily SHAP table: shap_results_csv/keyword_shap_table_{test_year}_k{num_keywords}.csv")
