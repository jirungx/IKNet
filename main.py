        ...
        for horizon in horizons:
            for train_start, test_start, train_df, test_df in windows:
                try:
                    ...
                    # # 저장
                    torch.save(model.state_dict(), f"{SAVE_DIR}/IKNet_{test_start}.pt")
                    joblib.dump(scaler_x, f"{SAVE_DIR}/scaler_x_{test_start}.pkl")
                    joblib.dump(scaler_y, f"{SAVE_DIR}/scaler_y_{test_start}.pkl")
                    ...
                    result_df.to_csv(f"results/IKNet_preds/IKNet_{test_start}.csv", index=False)
